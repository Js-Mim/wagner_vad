...
exp_settings = {
    ...
    'split_name': 'split_a_ext',       # Data split identifier for saving the results under different folder
    'split_training_indx': 3,          # Integer indicating up to which opera will be used for training (#2: uses Barenboi-Kupfer and Haitink)
